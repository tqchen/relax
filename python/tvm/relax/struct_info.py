...
class FuncStructInfo(StructInfo):
    ...
    @staticmethod
    def opaque_func(derive_func: Optional[EnvFunc] = None, span: Span = None) -> "FuncStructInfo":
        """
        ...
        info: FuncStructInfo
        """
        return _ffi_api.FuncStructInfoOpaqueFunc(derive_func, span)
...
def get_type_shape_from_structure_info(
    ...
    elif isinstance(struct_info, FuncStructInfo):
