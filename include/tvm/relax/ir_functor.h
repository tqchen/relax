...
class IRFunctor<R(const ObjectRef& n, Args...)> {
 ...
 public:
  ...
  virtual R VisitNode_(const relax::IfNode* op, Args... args) IR_FUNCTOR_DEFAULT;
 ...
 private:
  static FType InitVTable() {
    ...
    RELAX_IR_FUNCTOR_DISPATCH(GlobalVarNode);
    RELAX_IR_FUNCTOR_DISPATCH(relax::TupleNode);
    RELAX_IR_FUNCTOR_DISPATCH(relax::TupleGetItemNode);
    RELAX_IR_FUNCTOR_DISPATCH(relax::IfNode);
    RELAX_IR_FUNCTOR_DISPATCH(relax::CallNode);
